...
/// Used to configure how [DeclarativeRefreshIndicator] can be triggered.
...
///
/// The trigger mode is configured by [DeclarativeRefreshIndicator.triggerMode].
///
/// ## Troubleshooting
///
/// ### Refresh indicator does not show up
///
/// The [DeclarativeRefreshIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [DeclarativeRefreshIndicator] will always appear, even if the
...
/// ```
///
/// A [DeclarativeRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [DeclarativeRefreshIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [DeclarativeRefreshIndicator] to show
...
class DeclarativeRefreshIndicator extends StatefulWidget {
  ...
  /// Defines how this [DeclarativeRefreshIndicator] can be triggered when users overscroll.
  ///
  /// The [DeclarativeRefreshIndicator] can be pulled out in two cases,
...
/// Contains the state for a [DeclarativeRefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class DeclarativeRefreshIndicatorState
    extends State<DeclarativeRefreshIndicator>
    with TickerProviderStateMixin<DeclarativeRefreshIndicator> {
  ...
  @override
  void didUpdateWidget(covariant DeclarativeRefreshIndicator oldWidget) {
  ...
  ///
  /// Creating the [DeclarativeRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [DeclarativeRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [DeclarativeRefreshIndicator.onRefresh] callback's future completes.
  ///
